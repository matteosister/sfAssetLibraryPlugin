...
<?php if (!$folder->isRoot()): ?>
  <div class="assetImage">
    <div class="thumbnails">
      <?php echo link_to_asset(image_tag('/sfAssetsLibraryPlugin/images/up', 'size=64x64 alt=up title='.__('Parent directory', null, 'sfAsset')), '@sf_asset_library_list?dir='. $folder->getParentPath()) ?>
    </div>
...
<?php foreach ($dirs as $dir): ?>
  <div class="assetImage">
    <div class="thumbnails">
      <?php echo link_to_asset(image_tag('/sfAssetsLibraryPlugin/images/folder', 'size=64x64 alt=folder title='.$dir->getName()), '@sf_asset_library_list?dir='.$dir->getRelativePath()) ?>
    </div>
