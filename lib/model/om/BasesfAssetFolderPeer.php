...
abstract class BasesfAssetFolderPeer {
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TREE_LEFT', 'TREE_RIGHT', 'NAME', 'RELATIVE_PATH', 'CREATED_AT', 'UPDATED_AT', ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TREE_LEFT' => 1, 'TREE_RIGHT' => 2, 'NAME' => 3, 'RELATIVE_PATH' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, ),
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn($alias . '.RELATIVE_PATH');
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BasesfAssetFolderPeer', $criteria, $con);
		}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to sf_asset_folder
	 * by a foreign key with ON DELETE CASCADE
	 */
	public static function clearRelatedInstancePool()
	{
		// Invalidate objects in sfAssetPeer instance pool, 
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (sfAssetFolder object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = sfAssetFolderPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = sfAssetFolderPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + sfAssetFolderPeer::NUM_COLUMNS;
		} else {
			$cls = sfAssetFolderPeer::OM_CLASS;
			$obj = new $cls();
	...
	{
	  $dbMap = Propel::getDatabaseMap(BasesfAssetFolderPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BasesfAssetFolderPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new sfAssetFolderTableMap());
	  }
	}
	...
	{
		return $withPrefix ? sfAssetFolderPeer::CLASS_DEFAULT : sfAssetFolderPeer::OM_CLASS;
	}
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(sfAssetFolderPeer::ID);
			if ($value) {
				$selectCriteria->add(sfAssetFolderPeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(sfAssetFolderPeer::TABLE_NAME);
			}
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$affectedRows += BasePeer::doDeleteAll(sfAssetFolderPeer::TABLE_NAME, $con, sfAssetFolderPeer::DATABASE_NAME);
			// Because this db requires some delete cascade/set null emulation, we have to
			// clear the cached instance *after* the emulation has happened (since
			// instances get re-added by the select statement contained therein).
			sfAssetFolderPeer::clearInstancePool();
			sfAssetFolderPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof sfAssetFolder) { // it's a model object
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += sfAssetFolderPeer::doOnDeleteCascade($c, $con);
	...
	public static function doValidate($obj, $cols = null)
	{
		...
		return BasePeer::doValidate(sfAssetFolderPeer::DATABASE_NAME, sfAssetFolderPeer::TABLE_NAME, $columns);
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BasesfAssetFolderPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
...
//
BasesfAssetFolderPeer::buildTableMap();
